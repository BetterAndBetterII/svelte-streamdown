...
export type CompatSnippetKeys<Source extends Record<string, any> = Record<string, any>> = keyof Omit<
	Snippets<Source>,
	'mermaid'
>;
...
export type StreamdownProps<Source extends Record<string, any> = Record<string, any>> = {
	...
	children?: Snippet<
		[{ streamdown: StreamdownContext<Source>; token: GenericToken; children: Snippet }]
	>;
...
export type StreamdownContextInit<Source extends Record<string, any> = Record<string, any>> = Omit<
	StreamdownProps<Source>,
	| CompatSnippetKeys<Source>
	| 'animation'
	| 'class'
