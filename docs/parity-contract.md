...
| `interact-07` | Footnote popover interaction instead of the reference footnote-section plus backref model                                            | Approved as explicit current drift. Any PR that claims reference-equivalent footnote parity must remove this drift and update the matrix/contract first.            |
